                ...
                ListHeaderComponent={
                    <View>
                        ...
                        <View className="flex-row items-center justify-between px-5 pt-4 pb-5">
                            <Image
                                source={require("../../../assets/images/propeasy.png")}
                                style={{ width: 90, height: 36 }}
                                resizeMode="contain"
                            />
                            <View className="items-end">
                                <Text className="text-gray-500 text-xs">{getGreeting()}</Text>
                        ...
                        >
                            ...
                            <TouchableOpacity
                                ...
                                className="w-8 h-8 bg-amber-500 rounded-xl items-center justify-center"
                            >
